...
from flashsloth.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, LEARNABLE_TOKEN, LEARNABLE_TOKEN_INDEX, LEARNABLE_TOKEN_INDEX_QWEN
...
class LlavaMetaForCausalLM(ABC):
        ...
        if version == "plain":
            ...
            for _, (cur_labels, cur_batch_indices, num ) in enumerate(zip(labels, batch_indices, modal)):
                ...
                if num == 1:#single modal
                    first_question_start = 36
                elif num==2:    #multi modal
                    first_question_start = 36 + image_token_len + 1
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        if model_version in ['phi2', 'qwen2.5']:
